...
foreach($this->Wishlist->wishlist as $k => $wishlist_item) {
    ...
    if($wishlist_item['id'] == $this->prod->id) {
        $prodkey = $k;
    }
}
...
<div class="col-sm-9">
    <div class="row">
        ...
        <div class="col-sm-8">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p class="text-gray alt-font">Наличие: <?
                        switch($this->prod->avail) {
                            case 0: echo 'нет'; break;
                            case 1: echo 'в наличии'; break;
                            case 2: echo 'уточняйте'; break;
                            case 3: echo 'снят с производства'; break;
                        }
                        ?></p>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form action="/cart/buy" method="post" id="prodform_<?=$this->prod->id?>">
                        <hr class="spacer-15">
                        <div class="row">
                        ...
                        <ul class="list list-inline">
                            <?if($this->prod->avail==1) {?>
                            <li>
                                <button type="button" class="btn btn-default btn-md round" onclick="buy(<?=$this->prod->id?>); return false;">
                            ...
                            <?}?>
                            <?if(!$iswish) {?>
                                <li><button type="button" class="btn btn-gray btn-md round active" onclick="wishlist(<?=$this->prod->id?>); location.reload();"><i class="fa fa-heart mr-5"></i>В список желаний</button></li>
                            <?} else {?>
                                <li><button type="button" class="btn btn-gray btn-md round" onclick="wishlist_delete('<?=$prodkey?>'); location.reload();"><i class="fa fa-heart mr-5"></i>Удалить из желаний</button></li>
                            <?}?>
                        </ul>
                    </form>
                </div><!-- end col -->
        ...
        <div class="col-xs-12">
            ...
            <!-- Tab panes -->
            <div class="tab-content light-background">
                                        ...
                                        <div class="product-col-2">
                                            ...
                                            <div class="col-md-3 col-eq-height cat-col-w nopadding">
                                                <div class="product-col cat-col nopadding">
                                                    <div class="image">
                                                        <a href="/catalog/<?=$cat->intname?>/<?=$this->prod->id?>">
                                                            <?if(file_exists('pic/prod/'.$this->prod->id.'.jpg')) {?>
                                                                <img src="/thumb?src=pic/prod/<?=$this->prod->id?>.jpg&amp;width=244&amp;height=313&amp;crop=0" alt="<?=$this->prod->name?>" class="img-responsive img-center-sm" />
                                                            <?} else {?>
                                                                <img src="<?=$this->path?>/img/product-images/14.jpg" alt="<?=$this->prod->name?>" class="img-responsive img-center-sm" />
                                                            <?}?>
                                                        </a>
                                                    </div>
                                                    <div class="caption caption-2">
                                                        <h4><a href="/catalog/<?=$cat->intname?>/<?=$this->prod->id?>"><?=$this->prod->name?></a></h4>
                                                        <div class="pl-icons">
                                                            <?if($this->prod->sale){?><div class="pl-sale">Скидка</div><?}?>
                                                            <?if($this->prod->pop){?><div class="pl-top">Хит продаж</div><?}?>
                                                            <?if($this->prod->new){?><div class="pl-new">Новинка</div><?}?>
                                                            <?if($this->prod->best){?><div class="pl-best">Лучшая цена</div><?}?>
                                                        </div>
                                                        ...
                                                        <div class="price">
                                                            <span class="price-new"><?=ASweb\StdLib\Func::fmtmoney($this->prod->price)." ".$this->sett["valuta"]?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            $prodprice = $this->prod->price*(100-$kit->discount)/100;
                                            $price = $this->prod->price+$this->prod->price*(100-$kit->discount)/100;
//                                            $cat = $Cat->get($this->prod->cat);
                                            ?>
                                            <!-- Product Starts -->
                                            <div class="col-md-3 col-eq-height cat-col-w nopadding">
                                                <div class="product-col cat-col nopadding">
                                            ...
                                            <div class="col-md-4 col-eq-height cat-col-w nopadding">
                                                <div class="pa kitproddiscount">
                                                    <span>Ваша выгода - <?=ASweb\StdLib\Func::fmtmoney($this->prod->price+$this->prod->price-$price)." ".$this->sett["valuta"]?></span>
                                                </div>
                                                <div class="product-col cat-col pc-plus-2">
                                                    <div class="price-old">
                                                        <span class="price-new"><?=ASweb\StdLib\Func::fmtmoney($this->prod->price+$this->prod->price)." ".$this->sett["valuta"]?></span>
                                                    </div>
                                                    <div class="price">
            ...
            <?if(!empty($this->prod->childs)){?>
                ...
                <?if($opt['prod_childs']) echo $this->render("product/childs.php");?>
            <?}?>

            <?if(!empty($this->prod->analogs)){?>
                <hr class="spacer-30">
                <div class="row">
                    <div class="col-sm-12">
                ...
                <?if($opt['prod_analogs']) echo $this->render("products/analogs.php");?>
            <?}?>
        </div>
    </div>
</div>
